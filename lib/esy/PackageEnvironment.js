...
function computeEnvVarsForPackage(sandbox, packageInfo) {
  ...
  var _addEnvConfigForPacka = addEnvConfigForPackage({ seenVars: globalSeenVars, errors, normalizedEnvVars: [] }, sandbox.packageInfo.rootDirectory, packageName, rootDirectory, autoExportedEnvVarsForPackage);
  ...
  var _addEnvConfigForPacka2 = addEnvConfigForPackage({ seenVars, errors: nextErrors, normalizedEnvVars }, sandbox.packageInfo.rootDirectory, packageName, path.join(rootDirectory, 'package.json'), packageJson.esy.exportedEnv);
