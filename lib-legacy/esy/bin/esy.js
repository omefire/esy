...
let main = (() => {
  var _ref3 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* () {
    ...
    if (actualArgs.length === 0) {
      ...
      if (builtInCommand) {
        builtInCommand.apply(undefined, [curDir].concat((0, (_toConsumableArray2 || _load_toConsumableArray()).default)(process.argv.slice(3))));
      } else {
...
function formatError(message) {
  return `${(_chalk || _load_chalk()).default.red('ERROR')} ${message}`;
}
...
const builtInCommands = {
  "build-eject": (() => {
    var _ref2 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* (curDir) {
      ...
      buildEject.apply(undefined, [sandbox].concat((0, (_toConsumableArray2 || _load_toConsumableArray()).default)(args)));
    });

    function buildEject(_x2) {
